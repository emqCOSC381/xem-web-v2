...
class Mpesa {
   ...
   * @constructor
   */
  constructor(shortcode, consumerKey, consumerSecret, environment = 'sandbox') {
  ...
  async mpesaExpressRequest(
    ...
    try {
      ...
      throw new errors_1.DarajaError(error.message);
    }
  }
  /**
   *
   ...
   * })
   */
  async transactionStatusRequest(
    transactionId,
    identifierType,
    initiatorName,
    initiatorPassword,
